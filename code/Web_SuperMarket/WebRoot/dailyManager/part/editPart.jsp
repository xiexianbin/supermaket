...
-->
	...
	<body class="ContentBody">
		<form action="updatePart.action" method="post" name="vip" onsubmit="return check()">
			<div class="MainDiv">
												...
												<tr>
													...
													<td width="35%">
														<input name='deptId' readonly="readonly" type="text" class="text"
															style="width: 154px" value="${Part.deptId}" />
														<span class="red">*</span>
													</td>
													...
													<td width="34%">
														<input class="text" readonly="readonly" name='deptName' style="width: 154px"
															value="${Part.deptName}" /><span class="red">*</span>														
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														<input class="text" name='deptTel'
															style="width: 154px" value="${Part.deptTel}" />
													</td>
												</tr>
												<tr>
													<td align="right">
													...
													<td width="35%">
														<input name='deptAddress' type="text" class="text"
															style="width: 154px" value="${Part.deptAddress}" /></td>
												</tr>												
												<tr>
													<td align="right">
														备注:
													...
													<td colspan="3">
														<div>
														  ...
														  <textarea name="remarks" id="remarks" rows="5" cols="80" >${Part.remarks}</textarea>
														</div>
													</td>
												</tr>
											</table>
