...
<body class="ContentBody">
	<form action="addShelfMethod.action" method="post" name="frm">
		<div class="MainDiv">
			<table width="99%" border="0" cellpadding="0" cellspacing="0"
				class="CContent">
				<tr>
					<th class="tablestyle_title">添加货架</th>
				</tr>
				<tr>
					<td class="CPanel">
								...
								<td width="100%">
									<fieldset style="height: 100%;">
										...
										<table border="0" cellpadding="2" cellspacing="1"
											style="width: 100%">
											<tr>
												<td nowrap="nowrap" align="right" width="15%">货架编号:</td>
												<td width="35%"><input name='shelfId'
													readonly="readonly" type="text" class="text"
													style="width: 154px" value="${shelfId }" /> <span
													class="red">*</span></td>
												<td width="16%" align="right" nowrap="nowrap"></td>
												<td width="34%"></td>
											</tr>
											<tr>
												<td nowrap="nowrap" align="right">货架位置:</td>
												<td width="35%">
												...
												</select> <select name="shelfLocation_A">
												...
												</select> <input name='shelfLocation_N' type="text" class="text"
													style="width: 54px" value="" />(编号)</td>
												<td align="right"></td>
												<td></td>
											</tr>
											<tr>
												<td align="right">货架规格:</td>
												<td width="35%"><input name='shelfType' type="text"
