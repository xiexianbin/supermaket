...
-->
	...
	<body class="ContentBody">
		<form action="addNewSupplier.action" method="post" name="vip" onsubmit="return check()">
			<div class="MainDiv">
										...
										<fieldset style="height: 100%;">
											...
											<table border="0" cellpadding="2" cellspacing="1"
												...
												<tr>
													...
													<td width="34%">
														<input class="text" readonly="readonly" name='companyName' style="width: 154px"
												...
												<tr>
													...
													<td width="35%">
														<input name='companyShort' readonly="readonly" type="text" class="text"
															style="width: 154px" value="${Supplier.companyShort}" /></td>
													<td align="right">
														公司地址:
													</td>
													<td>
														<input class="text" readonly="readonly" type="text"  name='companyAddress'
												...
												<tr>
													...
													<td width="35%">
														<input name='manager' readonly="readonly" type="text" class="text"
															style="width: 154px" value="${Supplier.manager}" /><span class="red">*</span></td>
													<td align="right">
														联系电话:
													</td>
													<td width="35%">
														<input name='companyTel' readonly="readonly" type="text" class="text"
												...
												<tr>
													...
													<td width="35%">
														<input name='email' readonly="readonly" type="text" class="text"
															style="width: 154px" value="${Supplier.email}" /></td>
													<td align="right">
														邮政编码:
													</td>
													<td width="35%">
														<input name='postalCode' readonly="readonly" type="text" class="text"
												...
												<tr>
													...
													<td width="35%">
														<input name='fax' readonly="readonly" type="text" class="text"
															style="width: 154px" value="${Supplier.fax}" /></td>
													<td align="right">
														开户银行:
													</td>
													<td width="35%">
														<input name='bankName' readonly="readonly" type="text" class="text"
															style="width: 154px" value="${Supplier.bankName}" /></td>
												</tr>
												<tr>
													<td align="right">
														银行账户:
													...
													<td width="35%">
														<input name='bankAccounts' readonly="readonly" type="text" class="text"
												...
												<tr>
													...
													<div>
														  ...
														  <textarea name="remarks" readonly="readonly" id="remarks" rows="5" cols="80" >${Supplier.remarks}</textarea>
														</div>
													</td>
												</tr>
											</table>
