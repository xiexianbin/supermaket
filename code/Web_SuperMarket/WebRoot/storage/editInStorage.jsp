...
-->
	...
	<body class="ContentBody">
		<form action="updateInStorage.do" method="post">
			<div class="MainDiv">
										...
										<fieldset style="height: 100%;">
											...
											<table border="0" cellpadding="2" cellspacing="1"
												...
												<tr>
													...
													<td width="35%">
														<input name='inNum' type="text" class="text"
														...
														<td width="35%">
														<input name='inTime' type="text" class="text" id="date" onclick="new Calendar().show(this);" readonly="readonly" style="width: 154px" value="${inStorage.inTime}"/>
														</td>
												</tr>
												...
												<tr>
													...
													<td colspan="3">
													<input type="text" class="text" name="inReason" style="width: 75%" value="${inStorage.inReason}"/>
												...
												<tr>
													...
													<td colspan="3">
													<div>
														<textarea name="remarks" id="remarks" rows="7" cols="100">${inStorage.remarks}</textarea>
														</div>
													</td>
												</tr>
											</table>
