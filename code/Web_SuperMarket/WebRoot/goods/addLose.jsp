...
<body class="ContentBody">
	<form action="loseInsert.action" method="post" name="frm">
		<div class="MainDiv">
			<table width="99%" border="0" cellpadding="0" cellspacing="0"
				class="CContent">
				<tr>
					<th class="tablestyle_title">商品报损信息添加</th>
				</tr>
				<tr>
					<td class="CPanel">
							...
							<tr>
								<td width="100%">
									<fieldset style="height: 100%;">
										<legend>添加商品报损信息</legend>
										<table border="0" cellpadding="2" cellspacing="1"
											style="width: 100%">
											<tr>
												<td nowrap="nowrap" align="right" width="15%">报损流水号:</td>
												<td width="35%"><input name='serialId' type="text"
													class="text" style="width: 154px" value="${loseId}"
											...
											<tr>
												<td align="right">在售流水号:</td>
												<td><select id="purchId" name="purchId"
													onchange="JavaScript:selectOnsellInfo();">
											...
											<tr>
												...
												<td width="35%"><input name='productNorms'
													id="productNorms" type="text" class="text"
													style="width: 154px" readonly="readonly" /></td>
											</tr>
											<tr>
												<td align="right">在售数量：</td>
												<td><input name='count' id="count" type="text"
											...
											<tr>
												<td nowrap="nowrap" align="right" width="15%">报损数量:</td>
												<td width="35%"><input name='loseCount' id="loseCount" type="text"
