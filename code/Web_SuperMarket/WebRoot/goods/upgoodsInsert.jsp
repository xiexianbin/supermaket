...
<script type="text/javascript" src="js/Ajax_Add_up_goods.js"></script>
</head>

<body class="ContentBody">
	<form action="upgoodsInsert.action" method="post" name="frm">
		<div class="MainDiv">
			<table width="99%" border="0" cellpadding="0" cellspacing="0"
				class="CContent">
				<tr>
					<th class="tablestyle_title">商品上架信息添加</th>
				</tr>
				<tr>
					<td class="CPanel">
							...
							<tr>
								<td width="100%">
									<fieldset style="height: 100%;">
										<legend>添加商品上架信息</legend>
										<table border="0" cellpadding="2" cellspacing="1"
											style="width: 100%">
											<tr>
												<td nowrap="nowrap" align="right" width="15%">上架流水号:</td>
												<td width="35%"><input name='serialId' type="text"
													class="text" style="width: 154px" value="${SerialId}"
											...
											<tr>
												...
												<td><select id="purchId" name="purchId"
													onchange="javascript:selectPurchInfo();">
														<option value="" selected="selected">请选择</option>
														<c:forEach items="${purchList}" var="purch">
															<option value="${purch}">${purch}</option>
														</c:forEach>
												</select>(采购流水号-商品名称)</td>
												<td align="right"></td>
												<td></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><input name='productTime' id="productTime"
													type="text" class="text" style="width: 154px"
													readonly="readonly" />
												</td>
												<td align="right">过期日期:</td>
												<td><input name='expireTime' id="expireTime"
													type="text" class="text" style="width: 154px"
													readonly="readonly" /></td>
											</tr>
											<tr>
												<td align="right">生产商编号：</td>
												<td><input name='companyId' id="companyId" type="text"
													class="text" style="width: 154px" readonly="readonly" />
												</td>
												<td align="right">库存数量：</td>
												<td><input name='remainNum' id="remainNum" type="text"
													class="text" style="width: 154px" readonly="readonly" /></td>
											</tr>
											<tr>
												<td align="right">商品规格：</td>
												<td><input name='productNorms' id="productNorms" type="text"
													class="text" style="width: 154px" readonly="readonly" />
												</td>
											</tr>
											<tr>
												...
												<td nowrap="nowrap" align="right" width="15%">上架数量:</td>
												<td width="35%"><input name='upCount' type="text"
													class="text" style="width: 154px" value="${UpCount}" /> <!-- <span class="red">*</span> -->
												</td>
											</tr>
											<tr>
