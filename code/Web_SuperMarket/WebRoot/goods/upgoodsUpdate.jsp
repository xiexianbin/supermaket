...
-->
	...
	<body class="ContentBody">
		<form action="upgoodsUpdate.action" method="post">
			<div class="MainDiv">
										...
										<fieldset style="height: 100%;">
											...
											<table border="0" cellpadding="2" cellspacing="1"
												...
												<tr>
													...
													<td width="35%">
														<input name='serialId' type="text" class="text"
															style="width: 154px" value="${upgoods.serialId}" readonly="readonly" />
														<span class="red">*</span>
													</td>
													...
													<td width="34%">
														<input class="text" name='purchId' style="width: 154px"
															value="${upgoods.purchId}" readonly="readonly"/>
														<span class="red">*</span>
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														<input class="text" name='shelfId'
															style="width: 154px" value="${upgoods.shelfId}" />
													</td>
												</tr>
												<tr>
												<td align="right">
													...
													<td>
														<input class="text" name='upCount'
															style="width: 154px" value="${upgoods.upCount}" />
													</td>
												</tr>
												...
												<tr>
													...
													<td colspan="3">
														<textarea name="remarks" cols="100" rows="8" >${upgoods.remarks}</textarea>
													</td>
												</tr>
											</table>
											<br />
