...
function selectOnsellInfo(){
	createHttpRequest();
	var purchId = document.getElementById("purchId").value;
//	alert("selectOnsellInfo:"+purchId);
	if(purchId != ""){
		xmlHttp.open("post","onsellInfo.action?purchId="+purchId, true);
		xmlHttp.send(null);
...
//					alert(xmlHttp.responseText);
					...
					document.getElementById("count").value=goodsInfo[4];
